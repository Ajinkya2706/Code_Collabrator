...
const CallingTabContent: React.FC<{ roomID: string; userID: string; userName: string }> = ({
  roomID,
  userID,
  userName,
}) => {
  ...
  const handleLeaveCall = () => {
    setIsInCall(false);
    toast.info("Left the audio call");
  };
    ...
    return (
      <div className={cn("h-full flex flex-col", isFullscreen && "fixed inset-0 z-50 bg-black")}>
        ...
        <div className="flex items-center justify-between p-4 bg-gray-900 border-b border-gray-700">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-lg font-semibold text-white">Audio Call</h2>
            </div>
        ...
        <div className="flex-1 relative bg-gray-900">
          {/* ZegoCloud Audio Call Component */}
    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white">Audio Call</h2>
            <p className="text-sm text-gray-400">Real-time voice communication with ZegoCloud</p>
          </div>
        </div>
        <Badge variant="secondary" className="bg-green-500/20 text-green-400 border-green-500/30">
          {getConnectionQualityIcon()}
        ...
        <div className="text-center space-y-6 max-w-md">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Join the audio call powered by ZegoCloud for high-quality voice communication
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="bg-gray-800/50 rounded-lg p-3">
              <Mic className="w-5 h-5 text-green-400 mx-auto mb-1" />
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-400">
                    Click "Join Audio Call" to start. You'll be prompted to allow microphone access. 
                    The call will connect through ZegoCloud for optimal audio quality.
                  </p>
                </div>
              </div>
            </CardContent>
...
export default CallingTabContent;